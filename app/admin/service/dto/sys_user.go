...
func (s *ResetSysUserPwdReq) GetId() int {
	return s.UserId
}
...
func (s *UpdateSysUserAvatarReq) GetId() int {
	return s.UserId
}
...
func (s *UpdateSysUserStatusReq) GetId() int {
	return s.UserId
}
...
type SysUserUpdateReq struct {
	...
	Sex      string `json:"sex" comment:"性别"`
	Email    string `json:"email" comment:"邮箱" vd:"len($)>0,email"`
	DeptId   int    `json:"deptId,omitempty" comment:"部门"`
	PostId   int    `json:"postId" comment:"岗位"`
	Remark   string `json:"remark" comment:"备注"`
