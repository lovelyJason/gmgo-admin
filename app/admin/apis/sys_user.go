...
// @Router /api/v1/sys-user/get [get]
// @Security Bearer
...
// @Router /api/v1/sys-user/get/{userId} [post]
// @Security Bearer
func (e SysUser) Get(c *gin.Context) {
	...
	//数据权限检查
	p := actions.GetPermissionFromContext(c)
	err = s.Get(e.Context, &req, p, &object)
	if err != nil {
...
// @Success 200 {object} response.Response "{"code": 200, "data": [...]}"
// @Router /api/v1/sys-user/add [post]
// @Security Bearer
...
// @Success 200 {object} response.Response "{"code": 200, "data": [...]}"
// @Router /api/v1/sys-user/edit/{userId} [post]
// @Security Bearer
...
// @Success 200 {object} response.Response "{"code": 200, "data": [...]}"
// @Router /api/v1/user/pwd/reset [post]
// @Security Bearer
...
// @Success 200 {object} response.Response "{"code": 200, "data": [...]}"
// @Router /api/v1/user/pwd/set [post]
// @Security Bearer
...
func (e SysUser) GetInfo(c *gin.Context) {
	req := dto.SysUserById{}
	s := service.SysUser{}
	roleService := service.SysRole{}
	err := e.MakeContext(c).
		MakeMongo().
		MakeService(&roleService.Service).
		MakeService(&s.Service).
		Errors
	if err != nil {
		e.Logger.Error(err)
	...
	sysUser := models.SysUser{}
	req.Id = user.GetUserId(c)
	err = s.Get(e.Context, &req, p, &sysUser)
	if err != nil {
