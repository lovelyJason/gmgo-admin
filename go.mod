...
require (
	...
	golang.org/x/term v0.23.0 // indirect; indirect	golang.org/x/text v0.15.0 // indirect
...
replace (
	github.com/go-admin-team/go-admin-core v1.5.2-0.20231103105356-84418ed9252c => ./libs/go-admin-core
	github.com/go-admin-team/go-admin-core/sdk v1.5.2-0.20231103105356-84418ed9252c => ./libs/go-admin-core/sdk
)
